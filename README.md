...
FlowMind AI uses the cutting-edge **`gemini-1.5-flash`** model to drive its scheduling engine and chatbot:
...
sequenceDiagram
    ...
    Server->>Gemini: Models.generateContent(gemini-1.5-flash)
